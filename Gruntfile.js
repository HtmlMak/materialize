...
//  Sass
        sass: {                              // Task
            ...
            laco: {
                ...
                files  : {
                    'bin/laco.css': 'sass/laco.scss',
                    'bin/default-skin.css': 'sass/laco/default-skin.scss'
                }
            },
...
//  Notifications
    ...
    grunt.registerTask('sass_compile', ['sass:gh', 'sass:laco', 'sass:bin', 'postcss:gh', 'postcss:bin', 'notify:sass_compile']);
